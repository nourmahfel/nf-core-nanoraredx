...
include { FILTER_SV_CALLS as FILTER_SV_CALL_CUTESV } from '../../modules/local/filter_sv_calls'
include { GUNZIP } from '../../modules/nf-core/gunzip/main.nf'
workflow filterbycov_sv_cutesv {
    ...
    ch_versions = ch_versions.mix(FILTER_SV_CALL_CUTESV.out.versions)

    emit:
    filtered_vcf = FILTER_SV_CALL_CUTESV.out.filtered_vcf  // channel: [meta, filtered_vcf]
