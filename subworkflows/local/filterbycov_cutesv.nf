...
include { FILTERBYCOV_SV as FILTERBYCOV_CUTESV } from '../../modules/local/filterbycov_sv/main'

workflow filterbycov_cutesv_subworkflow {
    ...
    ch_versions = ch_versions.mix(FILTERBYCOV_CUTESV.out.versions)

    emit:
    filtered_vcf = FILTERBYCOV_CUTESV.out.filterbycov_vcf  // channel: [meta, filtered_vcf]
